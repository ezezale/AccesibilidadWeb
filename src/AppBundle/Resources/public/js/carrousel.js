...
var myCarousel = (function() {
  ...
  function init(set) {
    ...
    ctrls.innerHTML = '<li>' +
    '<button type="button" class="btn-prev"><img src="bundles/app/design/flecha_left.png" alt="Previous Slide"></button>' +
    '</li>' +
    '<li>' +
    '<button type="button" class="btn-next"><img src="bundles/app/design/flecha_right.png" alt="Next Slide"></button>' +
    '</li>';
